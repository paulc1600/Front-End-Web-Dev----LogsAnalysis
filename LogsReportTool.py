...
def open_report_page():
    ...
    my_date = (calendar.month_abbr[now.month] +
               ' ' + str(now.day) +
               ', ' + str(now.year))

    # Access database, answer 1st question: Show the most popular 3 articles?
    ...
    # Answer 3rd question: On which days more than 1% of req lead to errors?
    very_big_SQL = '''
    ...
    for q1_results_row in q1_rows_list:
        q1_results_str = (q1_results_str +
                          '\t' + str(q1_results_row[0]) +
                          ' -- ' + str(q1_results_row[1]) +
                          ' views ' + '\n')
    ...
    for q2_results_row in q2_rows_list:
        ...
        q2_results_str = (q2_results_str +
                          '\t' + q2e0_results_padded +
                          ' -- ' + str(q2_results_row[1]) +
                          ' views ' + '\n')
    ...
    for q3_results_row in q3_rows_list:
        q3_results_str = (q3_results_str +
                          '\t' + str(q3_results_row[0]) +
                          '\t -- ' + str(q3_results_row[1]) +
                          '% errors ' + '\n')
